...
Summary tables for duration, intensity, f0, and f2.
...
lmer(duration ~ island + (1|speaker) + (1|word), tidy_dur) |> 
  summary()

lmer(intensity ~ island + (1|speaker) + (1|word), data = tidy_intense) |>
  summary()

lmer(f0 ~ island + (1|speaker) + (1|word), data = tidy_f0) |>
  summary()

lmer(f2 ~ island + (1|speaker) + (1|word), data = tidy_f2) |>
  summary()
...
- for duration: `r lm.beta.lmer(mod_dur)`




Model fit for duration, intensity, f0, and f2.

- Residuals for duration: `r mean(resid(mod_dur))` (these residuals should all be 0)

- Residuals for intensity: `r mean(resid(mod_intense))`

- Residuals for f0: `r mean(resid(mod_f0))`

- Residuals for f2: `r mean(resid(mod_f2))`
...
#ds4ling::diagnosis(mod_dur)

# residuals - mean should be 0
#mean(resid(mod_dur))


# multicollinearity - dealt with by using nested model comparison; the 'anova()' fx
