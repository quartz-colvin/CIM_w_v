...
\begin{itemize}
\item
  Residuals for duration: 0.00 (these residuals should all be 0)
\item
  Residuals for intensity: 0.00
\item
  Residuals for f0: 0.00
\item
  Residuals for f2: 0.00
\end{itemize}
...
\pandocbounded{\includegraphics[keepaspectratio]{AFLA_manuscript_files/figure-latex/wv-barplot-1.pdf}}
